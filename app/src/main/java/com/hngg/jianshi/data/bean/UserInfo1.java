...
public class UserInfo1 {
    ...
    public static class PgcInfoBean {
        ...
        public Object getMedalsActionUrl() {
            return medalsActionUrl;
        }

        public void setMedalsActionUrl(Object medalsActionUrl) {
            this.medalsActionUrl = medalsActionUrl;
        }

        public Object getTagNameExport() {
            return tagNameExport;
        }

        public void setTagNameExport(Object tagNameExport) {
            this.tagNameExport = tagNameExport;
        }
