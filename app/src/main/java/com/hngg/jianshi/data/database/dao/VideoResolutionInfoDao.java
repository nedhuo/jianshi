...
/** 
 * DAO for table "VIDEO_RESOLUTION_INFO".
*/
public class VideoResolutionInfoDao extends AbstractDao<VideoResolutionInfo, Long> {

    public static final String TABLENAME = "VIDEO_RESOLUTION_INFO";
    ...
    public VideoResolutionInfoDao(DaoConfig config) {
        super(config);
    }
    
    public VideoResolutionInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"VIDEO_RESOLUTION_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"VIDEO_RESOLUTION_INFO\"";
        db.execSQL(sql);
    }
