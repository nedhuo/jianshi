...
package com.hngg.jianshi.ui.crash;
...
public final class DefaultErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button moreInfoButton = (Button) findViewById(R.id.btn_moreInfo);
        ...
        if (config.isShowErrorDetails()) {
            moreInfoButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.font_12sp));
                }
            });
        } else {
        ...
        ImageView errorImageView = ((ImageView) findViewById(R.id.iv_errorImage));
